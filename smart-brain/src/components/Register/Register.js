...
class Register extends Component {
    ...
    onSubmitRegister = () => {
        fetch('https://git.heroku.com/hidden-mesa-50173.git/register', { // tu fetch przyjmuje drugi parametr który jest obiektem w którym określamy to co będziemy wysyłać
